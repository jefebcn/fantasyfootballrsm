...
const VERSION = 'fcs-v0.1.0';
const SHELL = [
  './', './index.html', './manifest.webmanifest', './styles/app.css', './design/tokens/tokens.css',
  './src/app.js', './src/state.js', './src/data.js', './src/engine.js', './src/ui.js', './src/sprite.js',
  ...
  './src/views/regolamento.js', './src/views/scheda.js', './src/views/impostazioni.js', './src/views/mercato.js', './src/views/admin.js',
