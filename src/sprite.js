export const SPRITE = `<svg width="0" height="0" style="position:absolute" aria-hidden="true">
  <symbol id="i-towers" viewBox="0 0 64 56">
    <!-- Guaita, Cesta, Montale: tre torri merlate su tre cime -->
    <path d="M2 54 L14 30 L26 54 Z M22 54 L36 22 L50 54 Z M42 54 L54 34 L62 54 Z" fill="currentColor" opacity=".35"/>
    <path d="M9 36h10v-8h-2v3h-2v-3h-2v3h-2v-3h-2zM30 22h12V12h-2v3h-2v-3h-2v3h-2v-3h-2zM50 34h9v-7h-2v2h-1.5v-2h-2v2H52v-2h-2z" fill="currentColor"/>
    <path d="M36 12V4l5 2-5 2" fill="currentColor"/>
    <rect x="9" y="36" width="10" height="18" fill="currentColor"/><rect x="30" y="22" width="12" height="32" fill="currentColor"/><rect x="50" y="34" width="9" height="20" fill="currentColor"/>
  </symbol>
